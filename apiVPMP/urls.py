...
urlpatterns = patterns('',
    ...
    url(r'^report/filter/status=(?P<status>\w+)/$','api.views.report_status_filter'),
    url(r'^report/filter/gender=(?P<gender>\w+)/$','api.views.report_gender_filter'),
    url(r'^report/filter/state=(?P<state>\w+)/$','api.views.report_state_filter'),
    url(r'^report/filter/age=(?P<lowerAge>[0-9]+)&(?P<higherAge>[0-9]+)/$','api.views.report_age_filter'),
    url(r'^report/filter/missing_date=(?P<day>[0-9]{2})&(?P<month>[0-9]{2})&(?P<year>[0-9]{4})/$', 'api.views.report_missingdate_filter'),
